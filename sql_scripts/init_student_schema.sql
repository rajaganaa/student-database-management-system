...
INSERT INTO ENROLLMENT(studentId, courseId, enrollmentDate) VALUES (1,30,CURDATE()),(2,29,CURDATE()),(3,28,CURDATE()),
...
(25,6,CURDATE()),(26,5,CURDATE()),(27,4,CURDATE()),(28,3,CURDATE()),(29,2,CURDATE()),(30,1,CURDATE())
;
